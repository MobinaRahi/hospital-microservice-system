package hospital.inventoryservice.security.model;
 ...
 * Includes tenantId for data isolation per tenant.
 *
 * @author MobinaRahi
 */
@Getter
public class SecurityUser implements UserDetails, Serializable {
     ...
     * Used by CustomUserDetailsService when loading user from AuthService API.
     */
