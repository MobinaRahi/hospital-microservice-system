package hospital.labservice.security.provider;
...
/**
 * JWT Token Provider for LabService.
 * Validates tokens issued by AuthService and extracts tenantId.
 *
 ...
 *   <li>Tenant ID extraction for multi-tenancy</li>
 * </ul>
 *
 * @author MobinaRahi
 */
...
public class JwtTokenProvider {
     ...
     * Used by JwtAuthenticationFilter to set TenantContext for multi-tenant data isolation.
     *
