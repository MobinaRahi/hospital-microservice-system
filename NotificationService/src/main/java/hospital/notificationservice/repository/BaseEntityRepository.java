...
import hospital.notificationservice.model.BaseEntity;
 ...
 * <ul>
 *   <li><b>Soft delete:</b> Records are marked as deleted, not physically removed</li>
 *   <li><b>Optimistic locking:</b> Version field prevents concurrent modification conflicts</li>
 *   <li><b>Conflict handling:</b> Graceful error messages for concurrent updates</li>
 *   <li><b>Tenant isolation:</b> All queries are automatically filtered by tenantId</li>
 * </ul>
 *
...
public interface BaseEntityRepository<T extends BaseEntity, ID> extends JpaRepository<T, ID> {
     ...
     *
     * @return number of non-deleted entities
     */
